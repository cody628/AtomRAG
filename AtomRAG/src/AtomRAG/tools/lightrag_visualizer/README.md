# AtomRAG 3D Graph Viewer

An interactive 3D graph visualization tool included in the AtomRAG package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install AtomRAG-hku[tools]  # Install with visualization tool only
# or
pip install AtomRAG-hku[api,tools]  # Install with both API and visualization tools
```
...
1. **Command Not Found**
   ...
   pip install AtomRAG-hku[tools]

   # Verify installation
   pip list | grep AtomRAG-hku
   ```
...
- GitHub Issues: [AtomRAG Repository](https://github.com/HKUDS/AtomRAG)
- Documentation: [AtomRAG Docs](https://URL-to-docs)

## License

This tool is part of AtomRAG and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the AtomRAG package. Install with the [tools] option to access the viewer functionality.
